...
class AiKit_APP(AiKit_window, QMainWindow, QWidget):
    ...
    def _init_main_window(self):
        ...
        self.pix = QPixmap(libraries_path + '/res/logo.ico')  # the path to the icon
    ...
    def max_clicked(self):
        ...
        if self.isMaximized():
            ...
            self.showMaximized()
            # self.max_btn.setStyleSheet("border-image: url({}/AiKit_UI_img/nomel.ico);".format(libraries_path))
