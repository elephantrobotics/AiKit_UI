...
"border-style: outset;")
    ...
    def retranslateUi(self, AiKit_UI):
        ...
        self.comboBox_device.setItemText(3, _translate("AiKit_UI", "myPalletizer 260 for M5"))
        self.comboBox_device.setItemText(4, _translate("AiKit_UI", "mechArm 270 for Pi"))
        self.comboBox_device.setItemText(5, _translate("AiKit_UI", "ultraArm P340"))
        self.comboBox_device.setItemText(6, _translate("AiKit_UI", "myPalletizer 260 for Pi"))
        self.comboBox_device.setItemText(7, _translate("AiKit_UI", "mechArm 270 for M5"))
